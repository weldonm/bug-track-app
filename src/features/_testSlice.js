...
export const cartSlice = createSlice({
  ...
  initialState,
  reducers: {
    //adjust items or quantity to the cart
    ...
    //adding quantity to an item from cart
    addQuantity: (state, { payload }) => {
      state.totalQuantity += 1;
      state.listItems[payload.modelID].quantity += 1;
    },

    //removing quantity to an item from cart
